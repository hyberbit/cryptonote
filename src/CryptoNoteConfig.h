...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1fb962;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(5436920000000000);
...
const uint64_t MINIMUM_FEE                                   = 250;
...
const char     CRYPTONOTE_NAME[]                             = "Exogen";
